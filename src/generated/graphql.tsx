...
export type GetAllTournamentsQuery = { __typename?: 'Query', listedTournaments: Array<{ __typename?: 'Tournament', id: string, name: string, deadline: any, waitlistParticipantsCount: number, owner: { __typename?: 'User', id: string, username: string, avatar: string } } | null> };
...
export const DeleteTournamentDocument = gql`
    mutation deleteTournament($id: String!) {
